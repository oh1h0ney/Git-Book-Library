#!/bin/bash
echo -e '\033[1;32m 编译安装Python3.9.0a1 \033[0m'
echo -e '\033[1;32m 1.开始安装依赖包，centos里面是-devel，如果在ubuntu下安装则要改成-dev \033[0m'
yum -y groupinstall "Development tools"
yum -y install zlib-devel bzip2-devel openssl-devel ncurses-devel sqlite-devel readline-devel tk-devel gdbm-devel db4-devel libpcap-devel xz-devel libffi-devel
echo -e '\033[1;32m 2.获取python3.9.0a1的安装包 \033[0m'
wget -c https://www.python.org/ftp/python/3.9.0/Python-3.9.0a1.tar.xz
echo -e '\033[1;32m 3.解压 \033[0m'
tar -xvJf  Python-3.9.0a1.tar.xz
